odoo.define('ek_l10n_ec_pos_identification.screens', function(require) {
    'use strict';
    ...
    const POSSaveClientOverride = ClientListScreen =>
        class extends ClientListScreen {
            ...
            async saveChanges(event) {
                ...
                processedChanges = event.detail.processedChanges;
                console.log(processedChanges);
                let value_typeid = processedChanges['l10n_latam_identification_type_id'];
                processedChanges['l10n_latam_identification_type_id'] = parseInt(value_typeid);
                console.log(processedChanges);
